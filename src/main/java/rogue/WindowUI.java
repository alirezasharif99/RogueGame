...
**/
        public char getInput() {
         ...
         if (keyStroke.getKeyType() == KeyType.ArrowDown
            || (keyStroke.getKeyType() == KeyType.Character && keyStroke.getCharacter() == 'x')) {
            returnChar = Rogue.DOWN;  //constant defined in rogue
        } else if (keyStroke.getKeyType() == KeyType.ArrowUp
           || (keyStroke.getKeyType() == KeyType.Character && keyStroke.getCharacter() == 'e')) {
            returnChar = Rogue.UP;
        } else if (keyStroke.getKeyType() == KeyType.ArrowLeft
            || (keyStroke.getKeyType() == KeyType.Character && keyStroke.getCharacter() == 's')) {
            returnChar = Rogue.LEFT;
        } else if (keyStroke.getKeyType() == KeyType.ArrowRight
            || (keyStroke.getKeyType() == KeyType.Character && keyStroke.getCharacter() == 'd')) {
...
**/
   ...
   //set up the initial game display
    Player thePlayer = new Player("Alireza");
    theGame.setPlayer(thePlayer);
    message = "Welcome to my Rogue game";
    theGame.setCurrentRoomDisplay();
